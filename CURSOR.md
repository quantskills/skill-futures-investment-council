...
2. Read `README.md` and `README.en.md` for usage and packaging context.
3. Read `references/agent-integration.md`, `references/research-boundaries.md`, and `references/report-format.md` when shaping behavior or output.
4. Load only the relevant expert notes from `references/experts/`.
5. Call the bundled scripts in `scripts/` instead of reimplementing business logic.
